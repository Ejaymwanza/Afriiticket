                        ...
                        <div class="flexEqual" style="align-items:flex-start">
                            ...
                            <div class="textCenter mage_bus_seat_list">
                                ...
                                <div class="wbtm_anydate_return_wrap">
                                    <div class="wbtm_anydate_return_col"><?php _e('Any Date Return:', 'bus-ticket-booking-with-seat-reservation') ?></div>
                                    ...
                                    <script>
                                        jQuery(document).ready(function(){
                                            ...
                                            jQuery('.mage_bus_seat_item,.mage_bus_seat_item .mage_bus_seat_icon,.mage_bus_seat_item .passenger_type_list ul li').click(function (e) {
                                                jQuery('.wbtm_anydate_return_wrap').hide();

                                                setTimeout(
                                                function() {
                                                    let seat_list = jQuery('.mage_bus_selected_seat_list');
                                            ...
                                            jQuery('.wbtm_anydate_return_switch label').click(function (e) {
                                                ...
                                                let thisSubtotal = $this.parents('.wbtm_anydate_return_wrap').siblings('.mage_bus_sub_total').find('.price-figure');
